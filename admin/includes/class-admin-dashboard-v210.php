...
class LAA_Admin_Dashboard_v210 {
    
    public function __construct() {
        // Don't add admin menu here - let the main admin plugin handle it
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="case_id" name="case_id" class="regular-text" 
                                           value="<?php echo esc_attr($form_data['case_id'] ?? 'CASE-' . date('Y') . '-' . str_pad(wp_rand(1, 9999), 4, '0', STR_PAD_LEFT)); ?>" required>
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description">Mandant/Kanzlei (erforderlich)</p>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description">Erforderlich für Fallerstellung</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="case_id" name="case_id" value="<?php echo esc_attr($case->case_id); ?>" 
                                           class="regular-text" required readonly style="background: #f1f1f1;">
                                    <p class="description">Eindeutige Fall-Kennung (nicht änderbar)</p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="case_status">Status</label></th>
                        ...
                        <?php if ($court): ?>
                            <div style="background: #f0f8ff; padding: 15px; margin-top: 20px; border-radius: 5px;">
                                ...
                                <table class="form-table">
                                    ...
                                    <tr>
                                        <th>Adresse:</th>
                                        <td><?php echo esc_html($court->address ?: 'Nicht verfügbar'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Telefon:</th>
                                ...
                                <tbody>
                                    <?php foreach ($financials as $financial): ?>
                                        <tr>
                                            ...
                                            <td><?php echo esc_html($financial->payment_status); ?></td>
    ...
    private function create_new_case() {
        ...
        try {
            ...
            if (empty($debtors_last_name) && empty($emails_sender_email)) {
                $errors[] = 'Nachname des Schuldners oder Spam-Absender E-Mail ist erforderlich.';
            }
